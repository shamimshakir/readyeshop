            ...
            <div class="product-service">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>Shipping Anywhere</h4>
                        <p>Express, Urgent, Regular</p>
                    </div>
                </div>
                <div class="media">
                ...
                <div v-swiper:mySwiper="swiperOption">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div>
                                <div class="media" v-for="(product,index) in categoryNewProductRow1" :key="index">
                        ...
                        <div class="swiper-slide">
                            <div>
                                <div class="media" v-for="(product,index) in categoryNewProductRow2" :key="index">
                                    <router-link :to="{
                                        name: 'productdetails',
                                        params: {
                                        pdname: product.pd_name.replace(/\s+/g, '-').toLowerCase(),
...
export default {
    ...
    data() {
        return {
            ...
            categoryNewProductRow1: [],
            categoryNewProductRow2: [],
        }
    },
    computed: {
        currency() {
    ...
    methods: {
        ...
        async getCategoryNewProducts() {
            let dataObj = {
                'category[]': this.category,
            };
            let productData1 = await this.$root.getFrontData(dataObj, `/api/product_param?page=1&limit=3`);
            let productData2 = await this.$root.getFrontData(dataObj, `/api/product_param?page=2&limit=3`);
            this.categoryNewProductRow1 = productData1.data.data.data;
            this.categoryNewProductRow2 = productData2.data.data.data;
            this.imageSrc = productData1.data.url;
        }
    }
}
</script>
