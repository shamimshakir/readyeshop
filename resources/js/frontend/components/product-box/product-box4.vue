<template>
  <div>
    <div class="img-wrapper">
      ...
      <div class="front text-center">
        <router-link :to="{
				    ...
				    id: product.id,
						...
						<img :src="getActiveImage()" :id="product.id" class="img-fluid bg-img" :alt="product.title"
							:key="index" />
					</router-link>
      </div>
      <div class="back">
      ...
      <div class="cart-box">
        <button data-toggle="modal" data-target="#addtocart" class="add-button add_cart"
        ...
        <a href="javascript:void(0)" title="Comapre" @click="addToCompare(product.id)" v-b-modal.modal-compare
					variant="primary">
