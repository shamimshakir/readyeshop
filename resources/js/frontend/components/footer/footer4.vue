					...
					<section class="small-section">
						<div class="row">
							<div class="col-xl-6 offset-xl-3">
								<div class="subscribe">
									<h4>newsletter</h4>
									<form class="form-inline subscribe-form classic-form" @submit.prevent="suscrives">
										<div class="form-group">
											<input v-model="suscrived.email" type="text" class="form-control"
												id="exampleFormControlInput" placeholder="Enter your email" />
										</div>
