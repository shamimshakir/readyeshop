! function() {
    ...
    ! function(o) {
        ...
        function i(e, t) {
            var n, o, r, i, a, s, l, c, u, d, p, f, m = t && t.split("/"),
                h = T.map,
                b = h && h["*"] || {};
            if (e) {
        ...
        h = function(e, t) {
            ...
            return t = t || function() {}, "function" == typeof n && (n = r, r = i), r ? f(o, e, t, n) : setTimeout(function() {
                f(o, e, t, n)
            }, 4), m
        }, m.config = function(e) {
            return m(e)
    ...
    o.prototype.validate = function(e, t) {
        ...
        }, n("Validator", function() {}), n("sform", function() {}), n("text", ["module"], function(e) {
            "use strict";
        ...
        function(e, t) {
            ...
            function A(e, t, n, o, i) {
                ...
                for (p.textContent = "", m = 0; a = f[m++];)
                    ...
                    for (d = 0; a = s[d++];) Ze.test(a.type || "") && n.push(a);
                return p
            }
            ...
            function L(e, t, n, r) {
                ...
                if (p && (i = A(t, e[0].ownerDocument, !1, e, r), a = i.firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
                    ...
                    if (l)
                        for (u = s[s.length - 1].ownerDocument, Se.map(s, E), d = 0; d < l; d++) c = s[d], Ze.test(c.type || "") && !Fe.access(c, "globalEval") && Se.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? Se._evalUrl && Se._evalUrl(c.src) : o(c.textContent.replace(lt, ""), u, c))
                }
                return e
            }
            ...
            function K(e, t, n) {
                ...
                for (o in t)
                    ...
                    for (o in f) l || (b ? "hidden" in b && (h = b.hidden) : b = Fe.access(e, "fxshow", {
                        display: c
                    }), i && (b.hidden = !h), h && v([e], !0), p.done(function() {
            ...
            Se.fn = Se.prototype = {
                ...
                for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || Te(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
                    if (null != (e = arguments[s]))
                        for (t in e) n = a[t], o = e[t], a !== o && (c && o && (Se.isPlainObject(o) || (r = Array.isArray(o))) ? (r ? (r = !1, i = n && Array.isArray(n) ? n : []) : i = n && Se.isPlainObject(n) ? n : {}, a[t] = Se.extend(c, i, o)) : void 0 !== o && (a[t] = o));
                return a
            }, Se.extend({
            ...
            var Ae = function(e) {
                function t(e, t, n, o) {
                    var r, i, a, s, l, u, p, f = t && t.ownerDocument,
                        m = t ? t.nodeType : 9;
                    ...
                    for (var t, n, o, r = e.length, i = v.relative[e[0].type], a = i || v.relative[" "], s = i ? 1 : 0, l = p(function(e) {
                        ...
                        if (n = v.relative[e[s].type]) u = [p(f(u), n)];
                            ...
                            if (n = v.filter[e[s].type].apply(null, e[s].matches), n[R]) {
                                ...
                                return b(s > 1 && f(u), s > 1 && d(e.slice(0, s - 1).concat({
                                    value: " " === e[s - 2].type ? "*" : ""
                                })).replace(ie, "$1"), n, s < o && g(e.slice(s, o)), o < r && g(e = e.slice(o)), o < r && d(e))
                            }
                            u.push(n)
                        } return f(u)
                }
                ...
                var T, y, v, S, x, A, P, M, C, k, G, B, E, H, D, L, I, O, N, R = "sizzle" + 1 * new Date,
                    V = e.document,
                    F = 0,
                    X = 0,
                    j = n(),
                ...
                y = t.support = {}, x = t.isXML = function(e) {
                    ...
                    filter: {
                        ...
                        CHILD: function(e, t, n, o, r) {
                            ...
                            return 1 === o && 0 === r ? function(e) {
                                ...
                                var c, u, d, p, f, m, h = i !== a ? "nextSibling" : "previousSibling",
                                    b = t.parentNode,
                                ...
                                if (b) {
                                    ...
                                    if (m = [a ? b.firstChild : b.lastChild], a && w) {
                                        for (p = b, d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === F && c[1], T = f && c[2], p = f && b.childNodes[f]; p = ++f && p && p[h] || (T = f = 0) || m.pop();)
                                        ...
                                        for (;
                                            (p = ++f && p && p[h] || (T = f = 0) || m.pop()) && ((s ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++T || (w && (d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [F, T]), p !== t)););
                    ...
                    pseudos: {
                        ...
                        contains: o(function(e) {
                            return e = e.replace(ge, we),
                                function(t) {
                                    return (t.textContent || t.innerText || S(t)).indexOf(e) > -1
                                }
                        }),
                        lang: o(function(e) {
                            return ue.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(ge, we).toLowerCase(),
                                function(t) {
                                    var n;
                                    do {
            ...
            Se.event = {
                ...
                add: function(e, t, n, o, r) {
                    ...
                    if (b)
                        for (n.handler && (i = n, n = i.handler, r = i.selector), r && Se.find.matchesSelector(tt, r), n.guid || (n.guid = Se.guid++), (l = b.events) || (l = b.events = {}), (a = b.handle) || (a = b.handle = function(t) {
                ...
                dispatch: function(e) {
                    var t, n, o, r, i, a, s = Se.event.fix(e),
                    ...
                    if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                        for (a = Se.event.handlers.call(this, s, c), t = 0;
                            ...
                            for (s.currentTarget = r.elem, n = 0;
                                (i = r.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(i.namespace) || (s.handleObj = i, s.data = i.data, void 0 !== (o = ((Se.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, l)) && !1 === (s.result = o) && (s.preventDefault(), s.stopPropagation()));
            ...
            ! function() {
                ...
                var o, r, i, a, s, l = se.createElement("div"),
            ...
            Se.extend({
                ...
                if (t) return (parseFloat(O(e, "marginLeft")) || e.getBoundingClientRect().left - Ke(e, {
                    marginLeft: 0
                }, function() {
            ...
            Se.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && o ? t ? this.addClass(e) : this.removeClass(e) : Te(e) ? this.each(function(n) {
                        ...
                        var t, r, i, a;
                        if (o)
                            for (r = 0, i = Se(this), a = J(e); t = a[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            Se.extend(Se.event, {
                trigger: function(t, n, o, r) {
                    ...
                    if (a = p = s = o = o || se, 3 !== o.nodeType && 8 !== o.nodeType && !Ct.test(m + Se.event.triggered) && (m.indexOf(".") > -1 && (h = m.split("."), m = h.shift(), h.sort()), c = m.indexOf(":") < 0 && "on" + m, t = t[Se.expando] ? t : new Se.Event(m, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : Se.makeArray(n, [t]), d = Se.event.special[m] || {}, r || !d.trigger || !1 !== d.trigger.apply(o, n))) {
                        ...
                        for (i = 0;
                            (a = f[i++]) && !t.isPropagationStopped();) p = a, t.type = i > 1 ? l : d.bindType || m, u = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle"), u && u.apply(a, n), (u = c && a[c]) && u.apply && Ve(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
            ...
            qt.href = Gt.href, Se.extend({
                ...
                ajax: function(t, n) {
                    ...
                    var r, i, a, s, l, c, u, d, p, f, m = Se.ajaxSetup({}, n),
                        h = m.context || m,
            ...
            we.cors = !!Kt && "withCredentials" in Kt, we.ajax = Kt = !!Kt, Se.ajaxTransport(function(t) {
                ...
                if (we.cors || Kt && !t.crossDomain) return {
                    send: function(r, i) {
                        ...
                        n = function(e) {
                            return function() {
                                n && (n = o = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? i(0, "error") : i(s.status, s.statusText) : i(Ut[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                    binary: s.response
                                } : {
                                    text: s.responseText
            ...
            Se.ajaxSetup({
                ...
                var r, i, a, s = !1 !== t.jsonp && ($t.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && $t.test(t.data) && "data");
                ...
                setOffset: function(e, t, n) {
                    var o, r, i, a, s, l, c, u = Se.css(e, "position"),
                        d = Se(e),
                        p = {};
        ...
        function(e, t) {
            ...
            var u = function() {
                    var e, t = document.createElement("tingle-test-transition"),
                        n = {
        ...
        function(e, t) {
            e("mobiledetect", [], function() {
                ...
                return i.FALLBACK_PHONE = "UnknownPhone", i.FALLBACK_TABLET = "UnknownTablet", i.FALLBACK_MOBILE = "UnknownMobile", a = "isArray" in Array ? Array.isArray : function(e) {
                    ...
                    } : r.isPhoneSized = function() {}, r._impl = i, r.version = "1.4.3 2018-09-08", r
            })
        }(function(e) {
            ...
            function u(e) {
                ...
                if (n) {
                    ...
                    var s = function() {
                        ...
                        }), ue.keydownHandlerAdded = !1), t.parentNode && t.parentNode.removeChild(t), G([document.documentElement, document.body], [S.shown, S["height-auto"], S["no-backdrop"], S["toast-shown"], S["toast-column"]]), Q() && (null !== A.previousBodyPadding && (document.body.style.paddingRight = A.previousBodyPadding + "px", A.previousBodyPadding = null), function() {
            ...
            var p, f = "SweetAlert2:",
                ...
                Me = Object.freeze({
                    ...
                    setProgressSteps: function(e) {
                        var t = o({}, ge.innerParams.get(this), {
                            progressSteps: e
                        });
                    ...
                    _main: function(t) {
                        ...
                        return new Promise(function(t) {
                            ...
                            ue.keydownHandlerAdded && (ue.keydownTarget.removeEventListener("keydown", ue.keydownHandler, {
                                capture: ue.keydownListenerCapture
                            }), ue.keydownHandlerAdded = !1), r.toast || (ue.keydownHandler = function(e) {
                                return function(e, t) {
                                    if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing)
                                        ...
                                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === i.confirmButton && D(i.cancelButton) ? i.cancelButton.focus() : document.activeElement === i.cancelButton && D(i.confirmButton) && i.confirmButton.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== w(t.allowEscapeKey) || (e.preventDefault(), s(a.DismissReason.esc));
                                    else if (e.target && n.getInput() && e.target.outerHTML === n.getInput().outerHTML) {
                                        if (-1 !== ["textarea", "file"].indexOf(t.input)) return;
                                        a.clickConfirm(), e.preventDefault()
                                    }
                                }(e, r)
                            }, ue.keydownTarget = r.keydownListenerCapture ? window : i.popup, ue.keydownListenerCapture = r.keydownListenerCapture, ue.keydownTarget.addEventListener("keydown", ue.keydownHandler, {
                                capture: ue.keydownListenerCapture
                            }), ue.keydownHandlerAdded = !0), n.enableButtons(), n.hideLoading(), n.resetValidationMessage(), r.toast && (r.input || r.footer || r.showCloseButton) ? k(document.body, S["toast-column"]) : G(document.body, S["toast-column"]);
            ...
            ! function(e) {
                ...
                function i() {
                    ...
                    r.ajax({
                        ...
                        console.log(e.GatewayPageURL), void 0 != e.status ? "success" == e.status ? e.data && -1 !== e.data.indexOf("http") ? setTimeout(function() {
                            l(e.data, e.logo)
                        }, 10) : e.GatewayPageURL && -1 !== e.GatewayPageURL.indexOf("http") ? setTimeout(function() {
                            l(e.GatewayPageURL + "?full=1", e.storeLogo)
                        }, 10) : s("Error!", "Payment processing fails! Error generating payment URL", "error", "Ok") : s("Error!", "Payment processing fails! Transaction is fail to generate", "error", "Ok") : s("Error!", "Payment processing fails! Invalid response from server", "error", "Ok")
                    }, function(e) {
                        o.fire({
                            title: "Error in Communication",
                            text: "Oops! Something wrong, Try again",
                            type: "error",
