                      ...
                      <div class="media">
                        <router-link :to="{
													...
													<img :id="product.id"
														...
														class="img-fluid bg-img" :alt="product.pd_name" />
												</router-link>
                ...
                <div class="offer-slider">
                  <div>
                    <div
                      ...
                      v-for="(product,index) in specialProducts.slice(2, 3)" :key="index"
                    >
                      <productBox4
                      @openquickview="showquickview" :product="product" :index="index"
												:image-src="imageSrc"
                    />
                    </div>
                  </div>
