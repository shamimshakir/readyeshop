                      ...
                      >
                        <div class="product-box2">
                          <div class="media">
                            ...
                            >
                              <img
                                :src="imageSrc+tabPro.pd_thumbnail"
                                :id="tabPro.id"
                            ...
                            <div class="media-body align-self-center">
                              ...
                              <ul class="color-variant" v-if="tabPro.productcolors.length > 0">
                                <li
                                  v-for="(variant, variantIndex) in tabPro.productcolors"
                                  :key="variantIndex"
                                >
                                  <a
  ...
  methods: {
    async getTabCategoryProducts(value) {
      for (let cats of this.category) {
                ...
                let productstagsData = await this.$root.getFrontData(dataObjs, `/api/producttag_param`);
                let productstagsArr = productstagsData.data.data[0].tag_label;
               // console.log(productstagsArr);

                this.tabProducts.push({
                    title: productstagsArr,
                    label: cats.value,
