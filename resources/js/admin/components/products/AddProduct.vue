...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add Product" btnRoute="products" btnName="Products" />
        <div class="card-body">
            <form @submit.prevent="addProduct($event)" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select :class="checkError('category_id')
                                    ? 'form-control border-danger'
                                    : 'form-control' " v-model="productInput.category_id">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="pd_code">Sizes
                                <toggle-button v-model="size_apply" :labels="{checked: 'Yes', unchecked: 'No'}" /></label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="product_detail">Product Detail
                                <toggle-button v-model="pd_detail_show" :labels="{checked: 'Yes', unchecked: 'No'}" /></label>
                            <tinymce id="d2" :other_options="tinyOptions" v-if="pd_detail_show" v-model="productInput.product_detail"></tinymce>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="product_specification">Product Specification
                                <toggle-button v-model="pd_spectification_show" :labels="{checked: 'Yes', unchecked: 'No'}" /></label>
                            <tinymce id="d3" :other_options="tinyOptions" v-if="pd_spectification_show" v-model="productInput.product_specification"></tinymce>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="product_warranty">Product Warranty
                                <toggle-button v-model="pd_warranty_show" :labels="{checked: 'Yes', unchecked: 'No'}" /></label>
                            <tinymce id="d4" :other_options="tinyOptions" v-if="pd_warranty_show" v-model="productInput.product_warranty"></tinymce>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            pd_detail_show: false,
            pd_spectification_show: false,
            pd_warranty_show: false,
            popular_stat: false,
            upsstat: false,
            new_stat: false,
            feature_stat: false,
    ...
    methods: {
        ...
        async getAllProductTags() {
            ...
            this.allProductTags = data.map(item => {
                return {
        ...
        addProduct(event) {
            ...
            this.product_images.forEach(proImg => {
                form.append("pro_img_name[]", proImg);
            });
            
            form.append("hst", this.productInput.hst ? this.productInput.hst : 0);
            this.axios
                .post(`${this.$store.state.hostBase}/api/user/products`, form, {
                    headers: {
