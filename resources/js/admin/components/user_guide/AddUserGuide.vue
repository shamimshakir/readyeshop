...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add User Guide" btnRoute="user_guides" btnName="User Guides" />
        <div class="card-body">
            <form @submit.prevent="adduserGuide($event)">
                ...
                <button type="submit" class="btn btn-primary">Create User Guide</button>
            </form>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        ...
        adduserGuide(event) {
            this.$root.addData(this.userGuide, '/api/user/userguides').then(response => {
                this.$fire({
                ...
                if (res.status == "error") {
                    ...
                    this.$fire({
                        title: "Failed to Add User Guide",
                        type: "warning",
                        timer: 2000
                    });
                }
