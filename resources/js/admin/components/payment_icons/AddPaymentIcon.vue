...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add Payment Logo" btnRoute="payment_logos" btnName="Payment Logos" />
        <div class="card-body">
            <form @submit.prevent="addPaymentIcon($event)">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <button type="submit" class="btn btn-primary">Add Payment Logo</button>
            </form>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        ...
        addPaymentIcon(event) {
            ...
            this.axios
                .post(`${this.$store.state.hostBase}/api/user/paymenticons`, form, {
                    headers: {
