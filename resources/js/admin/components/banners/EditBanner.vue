...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Edit Banner" btnRoute="banners" btnName="Banners" />
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <img class="img-thumbnail" :src="banner_image_url + banner.image" />
                        </div>
                    </div>
                </div>
    ...
    methods: {
        ...
        async getBanner() {
            ...
            let data = await this.$root.getAllDataWithImages(
                `/api/user/banners/${this.$route.params.id}`
            );
            this.banner_image_url = data[0].url;
            this.banner = data[0].data[0];
            this.loading = false;
        },
        UpdateBanner(event) {
            ...
            this.axios
                .post(`${this.$store.state.hostBase}/api/user/banners/${this.$route.params.id}?_method=PUT`, form, {
                    headers: {
