...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add Shipper" btnRoute="shippers" btnName="Shippers" />
        <div class="card-body">
            <form @submit.prevent="addShipper($event)">
                <div class="row">
                    <div class="col-lg-4">
...
export default {
    ...
    methods: {
        ...
        addShipper(event) {
            this.$root.addData(this.shipper, '/api/user/shippers').then(response => {
                this.$fire({
