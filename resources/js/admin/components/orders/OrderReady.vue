            ...
            <div class="card-body">
                ...
                <div v-bind:class="{ lessOpacity: loading }">
                    ...
                    <form @submit.prevent="OrderReady($event)">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="status_change_comment">Status Change Comment</label>
...
export default {
    ...
    methods: {
        OrderReady(e){
            this.$root.addData(this.orderInfo, '/api/user/orders/order_ready').then(response => {
                this.$fire({
        ...
        async getOrderDatas() {
            this.loading = true;
            this.status = await this.$root.getAllData("/api/user/orderStatus");
