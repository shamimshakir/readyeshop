    ...
    <div class="card m-b-30 mt-5">
        <div class="card-body">
            ...
            <div v-bind:class="{ lessOpacity: loading }">
                <form @submit.prevent="confirmOrder($event)">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label for="od_status">Internal note</label>
...
export default {
    ...
    methods: {
        confirmOrder(e) {
            this.$root.addData(this.orderInfo, '/api/user/orders/order_confirm').then(response => {
                this.$fire({
        ...
        async getOrderDatas() {
            ...
            let filterObj = {};
            filterObj.status = [];
            filterObj.status.push(5, 7);

            this.$root.addData(filterObj, "/api/user/orderstatus/paramMultiple").then(res => {
