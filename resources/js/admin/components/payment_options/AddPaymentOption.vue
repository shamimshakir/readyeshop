...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add Payment Option" btnRoute="payment_options" btnName="Payment Options" />
        <div class="card-body">
            <form @submit.prevent="addPaymentOption($event)">
                <div class="row">
                    <div class="col-lg-6">
...
export default {
    ...
    methods: {
        ...
        addPaymentOption(event) {
            this.$root.addData(this.paymentOption, '/api/user/paymentoptions').then(response => {
                this.$fire({
                ...
                if (res.status == "error") {
                    ...
                    this.$fire({
                        title: "Failed to Add Payment Option",
                        type: "warning",
                        timer: 2000
                    });
                }
