...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Edit Page" btnRoute="page_contents" btnName="Page Contents" />
        <div class="card-body">
            <vue-loaders-ball-clip-rotate-multiple v-if="loading" scale="1.5" color="#3f51b5" />
            <form @submit.prevent="updatePage($event)" v-bind:class="{ lessOpacity: loading }">
                <div class="row">
                    <div class="col-lg-4">
    ...
    methods: {
        ...
        async getPageContent() {
            ...
            let data = await this.$root.getAllData(
                `/api/user/pagecontents/${this.$route.params.id}`
            );
        ...
        updatePage(event) {
            this.$root.updateData(this.pageContent, `/api/user/pagecontents/${this.$route.params.id}`).then(response => {
                this.$fire({
