...
<div class="col-lg-12">
    <div class="card m-b-30 mt-5">
        <CardHeader title="Add Pack Size" btnRoute="pack_sizes" btnName="Pack Sizes" />
        <div class="card-body">
            <form @submit.prevent="AddPackSize($event)">
                <div class="row">
                    <div class="col-lg-4">
                ...
                <button type="submit" class="btn btn-primary">Create Pack Size</button>
            </form>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        ...
        AddPackSize(event) {
            this.$root.addData(this.packsize, '/api/user/packsizes').then(response => {
                this.$fire({
